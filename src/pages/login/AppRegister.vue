        ...
        <div class="login-box">
            <el-form :model="ruleForm" :rules="rules" ref="ruleForm" class="demo-ruleForm login-container" >
                ...
                <el-form-item prop="account">
                    <el-input type="text" v-model="ruleForm.account" placeholder="账号" auto-complete="off"></el-input>
                </el-form-item>
                ...
                <el-form-item prop="checkPass">
                    <el-input type="password" v-model="ruleForm.checkPass" placeholder="重复密码" auto-complete="off"></el-input>
                </el-form-item>
