  ...
  <div class="m-home">
    <el-row :gutter="20">
      ...
      <el-col :xs="24" :sm="12" :lg="6">
        <el-card class="m-box-card" shadow="hover">
          <div class="m-icon">
            <i class="fa fa-file-code-o" style="color: #409EFF;"></i>
          </div>
          <div class="m-content">
            <p>天气</p>
            <p>{{info.weather}}</p>
    ...
    <el-row :gutter="20">
      ...
      <el-col :sm="24" :lg="6">
        <el-row :gutter="20" align>
          <el-col :sm="12" :lg="24">
            <el-card class="m-box-card" shadow="hover" style="height: 215px;background-color: rgb(143, 201, 251);color:#ffffff;">
              <div slot="header">
  ...
  data () {
    return  {
      ...
      chartData1: {
        ...
        rows: [
          {'日期': '1/1', '访问用户': 1393, '下单用户': 1093, '下单率': 0.32, 'sd': 0.21,},
          {'日期': '1/2', '访问用户': 3530, '下单用户': 3230, '下单率': 0.26, 'sd': 0.21},
          {'日期': '1/3', '访问用户': 2923, '下单用户': 2623, '下单率': 0.76, 'sd': 0.21},
          {'日期': '1/4', '访问用户': 1723, '下单用户': 1423, '下单率': 0.49, 'sd': 0.21},
          {'日期': '1/5', '访问用户': 3792, '下单用户': 3492, '下单率': 0.323, 'sd': 0.21},
          {'日期': '1/6', '访问用户': 4593, '下单用户': 4293, '下单率': 0.78, 'sd': 0.21}
        ]
      },
      chartSettings1: {
        axisSite: {right: ['下单率']},
